...
/* 34-2.Vue.js 템플릿 MasterDetail 패턴 - 정보 모달팝업
  1. 정보 모달팝업 SlotModal 임포트 import SlotModal from '@/components/fragments/SlotModal.vue' / components: { 'slot-modal': SlotModal },
  2. MasterDetailView.vue의 목록 소스 가져오기 및 커스텀
  3. 클릭시 모달창이 뜨도록 수정 - 버튼을 추가하고 숨긴 다음 정보 선택시 버튼을 클릭하도록 강제하는 이빈트 onCellClick에 추가
    <button
      style="display: none"
      ref="btnModal"
      data-bs-toggle="modal"
    ...
    ** 배운 것들을 바탕으로 응용을 해야한다.
  4. 저장하기를 클릭하면 에디터 모드를 끌 수 있도록 수정

  ** 상단에 조회목록, 하단(혹은 모달팝업)에 클릭 시 상세정보 보고 수정할 수 있는 형태가 메인, 잘 익혀서 사용하자
 */
</script>
<style>
.link-primary {
