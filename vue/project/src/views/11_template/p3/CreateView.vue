...
/* 33-4. Vue.js 템플릿 ListToDetail 패턴 - CreateView
  1. 페이지 만들기 수정 화면의 코스 복붙, 불필요한 부분 삭제 및 커스텀
  2. 취소 버튼 클릭시 리스트로 가도록 수정
  3. 저장 이벤트 실행
    - put -> post
    - 수정할 id가 아닌 저장할 정보 추가
    - 전송 완료시 성공코드는 201
    - 저장완료시 팝업 문구 수정
    - 완료시 상세정보 화면으로 이동하게 하면 좋음, 생성되는 id를 받아와 상세화면으로 이동되게 수정
